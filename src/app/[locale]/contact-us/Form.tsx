...
const Form: FC<FormProps> = ({ }) => {
  ...
  return <div className="h-full grid sm:grid-cols-2 items-center  mt-4 sm:mt-8 rounded-md overflow-hidden">
    <div className="relative overflow-hidden">
      ...
      <div className="relative py-12 sm:py-24 px-8 sm:px-16">
